...
const ButtonDU: React.FC<ButtonDUProps> = ({ text, variant = 'primary', href, onClick }) => {
  // Define class names for primary and secondary variants
  const classNames = variant === 'primary'
    ? "bg-softsec text-white px-3 py-1 rounded-md text-lg hover:bg-secondary flex items-center"
    : "bg-white text-black px-3 py-1 rounded-md text-lg hover:bg-softsec border-2 border-softsec flex items-center";
