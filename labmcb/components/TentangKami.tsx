  ...
  return (
    <section id="about" className="py-12 space-y-12">
      <div className="relative container mx-auto px-4">
        ...
        <div
          className="bg-softaccent absolute top-[-30px] left-1/2 transform -translate-x-1/2 bg-gray-100 rounded-2xl w-[450px] h-[350px] shadow-[3px_8px_4px_#00000040]"
        ></div>

        <div className="relative z-10 text-center">
          <h2 className="text-3xl md:text-3xl font-bold mb-5">Tentang Kami</h2>
          <p className="text-gray-700 text-sm md:text-xs max-w-[350px] mx-auto leading-6 text-justify">
...
Kami terdiri dari tim ahli yang berpengalaman dalam bidang arkeologi, konservasi, dan pemeliharaan budaya, yang bekerja secara kolaboratif untuk melaksanakan penelitian, pemulihan, dan pelestarian struktur serta artefak yang ada di situs...
          ...
          <Link
            href="/pengenalan"
            className="mt-6 inline-flex text-sm items-center bg-secondary text-white px-3 py-2 rounded-md font-semibold transition-transform transform hover:scale-105 shadow-[3px_8px_4px_#00000040]"
          >
            Read More
            <img
